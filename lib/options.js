...
export default {
  ...
  tts_key: async function(arg) {
    ...
    // Capitalized to match KeyboardEvent.key ("Shift", not "shift") -
    // contentscript.js compares against this directly.
  ...
  popup_show_trigger: async function(arg) {
    ...
    // Capitalized to match KeyboardEvent.key ("Alt", not "alt") - same
    // reasoning as tts_key above.
